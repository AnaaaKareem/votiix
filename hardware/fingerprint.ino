...
// Routes through KrakenD API Gateway (port 8080)
const String KEYPAD_API = "http://" + SERVER_IP + ":8080/api/v1/kiosk/hardware/keypad";
const String VERIFY_API = "http://" + SERVER_IP + ":8080/api/v1/kiosk/hardware/verify-fingerprint";
const String ENROLL_NEXT_API = "http://" + SERVER_IP + ":8080/api/v1/kiosk/hardware/enrollment/next?device_code=" + DEVICE_CODE;
const String ENROLL_COMPLETE_API = "http://" + SERVER_IP + ":8080/api/v1/kiosk/hardware/enrollment/complete";
